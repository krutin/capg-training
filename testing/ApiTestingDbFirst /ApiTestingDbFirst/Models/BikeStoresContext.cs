...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=localhost,1433;Database=BikeStores;User Id=sa;Password=GhostRider123$;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Brand>(entity =>
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E27988FFEAE");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B44CB6CF40");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB851295AA45");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__4659622922C15B64");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4B5D53F41");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF53B06E925");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C952F4A5F");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E61643CC3B416").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D36A3F7ECE");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C94EEF6E3");
