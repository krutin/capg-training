...
namespace DbFirstDemo.Controllers
{
    ...
    public class CategoryControllers : ControllerBase
    {
        ...
        public CategoryControllers(YourDbContext context)
        {
            _context = context;
        }
        ...
        // DELETE: api/CategoryControllers/5
        [HttpDelete("{id}")]
